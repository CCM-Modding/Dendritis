...
public class DummyArmor extends ItemArmor implements IArmorTextureProvider {
    ...
    public DummyArmor(final int par1, final EnumArmorMaterial par2EnumArmorMaterial,
    ...
    public void registerIcons(final IconRegister register) {
        this.itemIcon = register.registerIcon(TextureHelper.getTextureFromName(
                this.getUnlocalizedName(), Locations.TEXTURE + "armor/"));
    }

    @Override
    public String getArmorTextureFile(final ItemStack stack) {

        if (stack.itemID == ModArmors.headAmethyst.itemID
                || stack.itemID == ModArmors.chestAmethyst.itemID
                || stack.itemID == ModArmors.bootsAmethyst.itemID)
        ...
        else if (stack.itemID == ModArmors.headBDiamond.itemID
                || stack.itemID == ModArmors.chestBDiamond.itemID
                || stack.itemID == ModArmors.bootsBDiamond.itemID)
        ...
        else if (stack.itemID == ModArmors.headCitrine.itemID
                || stack.itemID == ModArmors.chestCitrine.itemID
                || stack.itemID == ModArmors.bootsCitrine.itemID)
        ...
        else if (stack.itemID == ModArmors.headCZirconia.itemID
                || stack.itemID == ModArmors.chestCZirconia.itemID
                || stack.itemID == ModArmors.bootsCZirconia.itemID)
        ...
        else if (stack.itemID == ModArmors.headEmerald.itemID
                || stack.itemID == ModArmors.chestEmerald.itemID
                || stack.itemID == ModArmors.bootsEmerald.itemID)
        ...
        else if (stack.itemID == ModArmors.headFuchsia.itemID
                || stack.itemID == ModArmors.chestFuchsia.itemID
                || stack.itemID == ModArmors.bootsFuchsia.itemID)
        ...
        else if (stack.itemID == ModArmors.headJet.itemID
                || stack.itemID == ModArmors.chestJet.itemID
                || stack.itemID == ModArmors.bootsJet.itemID)
            return Locations.ARMOR + "Jet_1.png";
        else if (stack.itemID == ModArmors.legsJet.itemID)
            return Locations.ARMOR + "Jet_2.png";
        else if (stack.itemID == ModArmors.headOlivine.itemID
                || stack.itemID == ModArmors.chestOlivine.itemID
                || stack.itemID == ModArmors.bootsOlivine.itemID)
        ...
        else if (stack.itemID == ModArmors.headOpal.itemID
                || stack.itemID == ModArmors.chestOpal.itemID
                || stack.itemID == ModArmors.bootsOpal.itemID)
            return Locations.ARMOR + "Opal_1.png";
        else if (stack.itemID == ModArmors.legsOpal.itemID)
            return Locations.ARMOR + "Opal_2.png";
        else if (stack.itemID == ModArmors.headQuartz.itemID
                || stack.itemID == ModArmors.chestQuartz.itemID
                || stack.itemID == ModArmors.bootsQuartz.itemID)
            return Locations.ARMOR + "Quartz_1.png";
        else if (stack.itemID == ModArmors.legsQuartz.itemID)
            return Locations.ARMOR + "Quartz_2.png";
        else if (stack.itemID == ModArmors.headRuby.itemID
                || stack.itemID == ModArmors.chestRuby.itemID
                || stack.itemID == ModArmors.bootsRuby.itemID)
            return Locations.ARMOR + "Ruby_1.png";
        else if (stack.itemID == ModArmors.legsRuby.itemID)
            return Locations.ARMOR + "Ruby_2.png";
        else if (stack.itemID == ModArmors.headSapphire.itemID
                || stack.itemID == ModArmors.chestSapphire.itemID
                || stack.itemID == ModArmors.bootsSapphire.itemID)
        ...
        else if (stack.itemID == ModArmors.headSQuartz.itemID
                || stack.itemID == ModArmors.chestSQuartz.itemID
                || stack.itemID == ModArmors.bootsSQuartz.itemID)
        ...
        else if (stack.itemID == ModArmors.headSun.itemID
                || stack.itemID == ModArmors.chestSun.itemID
                || stack.itemID == ModArmors.bootsSun.itemID)
            return Locations.ARMOR + "Sun_1.png";
        else if (stack.itemID == ModArmors.legsSun.itemID)
            return Locations.ARMOR + "Sun_2.png";
        else if (stack.itemID == ModArmors.headTopaz.itemID
                || stack.itemID == ModArmors.chestTopaz.itemID
                || stack.itemID == ModArmors.bootsTopaz.itemID)
            return Locations.ARMOR + "Topaz_1.png";
        else if (stack.itemID == ModArmors.legsTopaz.itemID)
            return Locations.ARMOR + "Topaz_2.png";
        else if (stack.itemID == ModArmors.headTurquoise.itemID
                || stack.itemID == ModArmors.chestTurquoise.itemID
                || stack.itemID == ModArmors.bootsTurquoise.itemID)
        ...
        else if (stack.itemID == ModArmors.headWAlabaster.itemID
                || stack.itemID == ModArmors.chestWAlabaster.itemID
                || stack.itemID == ModArmors.bootsWAlabaster.itemID)
