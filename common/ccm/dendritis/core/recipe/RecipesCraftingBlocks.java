...
final class RecipesCraftingBlocks {
    ...
    private static void addShaped() {
        ...
        CraftingManager.getInstance().getRecipeList().add(new ShapedOreRecipe(EHandler.getItem(EnumBlocks.blockAmethyst), new Object[] { "xxx", "xxx", "xxx", 'x', EHandler.getItem(EnumGems.gemAmethyst) }));
        CraftingManager.getInstance().getRecipeList().add(new ShapedOreRecipe(EHandler.getItem(EnumBlocks.blockBDiamond), new Object[] { "xxx", "xxx", "xxx", 'x', EHandler.getItem(EnumGems.gemBDiamond) }));
        CraftingManager.getInstance().getRecipeList().add(new ShapedOreRecipe(EHandler.getItem(EnumBlocks.blockCitrine), new Object[] { "xxx", "xxx", "xxx", 'x', EHandler.getItem(EnumGems.gemCitrine) }));
        CraftingManager.getInstance().getRecipeList().add(new ShapedOreRecipe(EHandler.getItem(EnumBlocks.blockCZirconia), new Object[] { "xxx", "xxx", "xxx", 'x', EHandler.getItem(EnumGems.gemCZirconia) }));
        CraftingManager.getInstance().getRecipeList().add(new ShapedOreRecipe(EHandler.getItem(EnumBlocks.blockFuchsia), new Object[] { "xxx", "xxx", "xxx", 'x', EHandler.getItem(EnumGems.gemFuchsia) }));
        CraftingManager.getInstance().getRecipeList().add(new ShapedOreRecipe(EHandler.getItem(EnumBlocks.blockJet), new Object[] { "xxx", "xxx", "xxx", 'x', EHandler.getItem(EnumGems.gemJet) }));
        CraftingManager.getInstance().getRecipeList().add(new ShapedOreRecipe(EHandler.getItem(EnumBlocks.blockOlivine), new Object[] { "xxx", "xxx", "xxx", 'x', EHandler.getItem(EnumGems.gemOlivine) }));
        CraftingManager.getInstance().getRecipeList().add(new ShapedOreRecipe(EHandler.getItem(EnumBlocks.blockOpal), new Object[] { "xxx", "xxx", "xxx", 'x', EHandler.getItem(EnumGems.gemOpal) }));
        CraftingManager.getInstance().getRecipeList().add(new ShapedOreRecipe(EHandler.getItem(EnumBlocks.blockRuby), new Object[] { "xxx", "xxx", "xxx", 'x', EHandler.getItem(EnumGems.gemRuby) }));
        CraftingManager.getInstance().getRecipeList().add(new ShapedOreRecipe(EHandler.getItem(EnumBlocks.blockSapphire), new Object[] { "xxx", "xxx", "xxx", 'x', EHandler.getItem(EnumGems.gemSapphire) }));
        CraftingManager.getInstance().getRecipeList().add(new ShapedOreRecipe(EHandler.getItem(EnumBlocks.blockSQuartz), new Object[] { "xxx", "xxx", "xxx", 'x', EHandler.getItem(EnumGems.gemSQuartz) }));
        CraftingManager.getInstance().getRecipeList().add(new ShapedOreRecipe(EHandler.getItem(EnumBlocks.blockSun), new Object[] { "xxx", "xxx", "xxx", 'x', EHandler.getItem(EnumGems.gemSun) }));
        CraftingManager.getInstance().getRecipeList().add(new ShapedOreRecipe(EHandler.getItem(EnumBlocks.blockTopaz), new Object[] { "xxx", "xxx", "xxx", 'x', EHandler.getItem(EnumGems.gemTopaz) }));
        CraftingManager.getInstance().getRecipeList().add(new ShapedOreRecipe(EHandler.getItem(EnumBlocks.blockTurquoise), new Object[] { "xxx", "xxx", "xxx", 'x', EHandler.getItem(EnumGems.gemTurquoise) }));
        CraftingManager.getInstance().getRecipeList().add(new ShapedOreRecipe(EHandler.getItem(EnumBlocks.blockWAlabaster), new Object[] { "xxx", "xxx", "xxx", 'x', EHandler.getItem(EnumGems.gemWAlabaster) }));
    }
