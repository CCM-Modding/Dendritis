...
final class WorldRegistry
{
     ...
     * WorldGenHandler.addEndGenerator(new WorldGenMinable(new ItemStack(ModBlocks.ores.blockID, 1,
     * EnumOres.oreAmethyst.ordinal()), Properties.ameSize),
     ...
     * WorldGenHandler.addNetherGenerator(new WorldGenMinable(new ItemStack(ModBlocks.ores.blockID,
     * 1, EnumOres.oreBDiamond.ordinal()), Properties.bdiSize),
     ...
     * 1, EnumOres.oreCitrine.ordinal()), Properties.citSize),
     ...
     * WorldGenHandler.addNetherGenerator(new WorldGenMinable(new ItemStack(ModBlocks.ores.blockID,
     * 1, EnumOres.oreCZirconia.ordinal()), Properties.cziSize),
     ...
     * WorldGenHandler.addSurfaceGenerator(new WorldGenMinable(new ItemStack(ModBlocks.ores.blockID,
     * 1, EnumOres.oreFuchsia.ordinal()), Properties.fucSize),
     ...
     * WorldGenHandler.addEndGenerator(new WorldGenMinable(new ItemStack(ModBlocks.ores.blockID, 1,
     * EnumOres.oreJet.ordinal()), Properties.jetSize),
     ...
     * WorldGenHandler.addSurfaceGenerator(new WorldGenMinable(new ItemStack(ModBlocks.ores.blockID,
     * 1, EnumOres.oreOlivine.ordinal()), Properties.oliSize),
     ...
     * WorldGenHandler.addSurfaceGenerator(new WorldGenMinable(new ItemStack(ModBlocks.ores.blockID,
     * 1, EnumOres.oreOpal.ordinal()), Properties.opalSize),
     ...
     * WorldGenHandler.addSurfaceGenerator(new WorldGenMinable(new ItemStack(ModBlocks.ores.blockID,
     * 1, EnumOres.oreRuby.ordinal()), Properties.rubySize),
     ...
     * WorldGenHandler.addSurfaceGenerator(new WorldGenMinable(new ItemStack(ModBlocks.ores.blockID,
     * 1, EnumOres.oreSapphire.ordinal()), Properties.sapSize),
     ...
     * WorldGenHandler.addNetherGenerator(new WorldGenMinable(new ItemStack(ModBlocks.ores.blockID,
     * 1, EnumOres.oreSQuartz.ordinal()), Properties.squSize),
     ...
     * WorldGenHandler.addSurfaceGenerator(new WorldGenMinable(new ItemStack(ModBlocks.ores.blockID,
     * 1, EnumOres.oreSun.ordinal()), Properties.sunSize),
     ...
     * WorldGenHandler.addSurfaceGenerator(new WorldGenMinable(new ItemStack(ModBlocks.ores.blockID,
     * 1, EnumOres.oreTopaz.ordinal()), Properties.topSize),
     ...
     * WorldGenHandler.addSurfaceGenerator(new WorldGenMinable(new ItemStack(ModBlocks.ores.blockID,
     * 1, EnumOres.oreTurquoise.ordinal()), Properties.turSize),
     ...
     * WorldGenHandler.addEndGenerator(new WorldGenMinable(new ItemStack(ModBlocks.ores.blockID, 1,
     * EnumOres.oreWAlabaster.ordinal()), Properties.walSize),
