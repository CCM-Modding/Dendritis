...
final class WorldRegistry
{
    ...
    private static void registerBDiamond()
    {
        ...
        WorldGenHandler.addNetherGenerator(new WorldGenMinable(new ItemStack(ModBlocks.ores.blockID, 1, EnumOres.oreBDiamond.ordinal()), Properties.bdiSize),
                                           Properties.bdiMinHeight,
                                           Properties.bdiMaxHeight,
                                           Properties.bdiDensity,
                                           WorldGenHandler.GenType.ORE_1.ordinal());
    }
    ...
    private static void registerCitrine()
    {
        ...
        WorldGenHandler.addSurfaceGenerator(new WorldGenMinable(new ItemStack(ModBlocks.ores.blockID, 1, EnumOres.oreCitrine.ordinal()), Properties.citSize),
                                            Properties.citMinHeight,
                                            Properties.citMaxHeight,
                                            Properties.citDensity,
                                            WorldGenHandler.GenType.ORE_1.ordinal());
    }
    ...
    private static void registerCZirconia()
    {
        ...
        WorldGenHandler.addNetherGenerator(new WorldGenMinable(new ItemStack(ModBlocks.ores.blockID, 1, EnumOres.oreCZirconia.ordinal()), Properties.cziSize),
                                           Properties.cziMinHeight,
                                           Properties.cziMaxHeight,
                                           Properties.cziDensity,
                                           WorldGenHandler.GenType.ORE_1.ordinal());
    }
    ...
    private static void registerFuchsia()
    {
        ...
        WorldGenHandler.addSurfaceGenerator(new WorldGenMinable(new ItemStack(ModBlocks.ores.blockID, 1, EnumOres.oreFuchsia.ordinal()), Properties.fucSize),
                                            Properties.fucMinHeight,
                                            Properties.fucMaxHeight,
                                            Properties.fucDensity,
                                            WorldGenHandler.GenType.ORE_1.ordinal());
    }
    ...
    private static void registerJet()
    {
        ...
        WorldGenHandler.addEndGenerator(new WorldGenMinable(new ItemStack(ModBlocks.ores.blockID, 1, EnumOres.oreJet.ordinal()), Properties.jetSize),
                                        Properties.jetMinHeight,
                                        Properties.jetMaxHeight,
                                        Properties.jetDensity,
                                        WorldGenHandler.GenType.ORE_1.ordinal());
    }
    ...
    private static void registerOlivine()
    {
        ...
        WorldGenHandler.addSurfaceGenerator(new WorldGenMinable(new ItemStack(ModBlocks.ores.blockID, 1, EnumOres.oreOlivine.ordinal()), Properties.oliSize),
                                            Properties.oliMinHeight,
                                            Properties.oliMaxHeight,
                                            Properties.oliDensity,
                                            WorldGenHandler.GenType.ORE_1.ordinal());
    }
    ...
    private static void registerOpal()
    {
        ...
        WorldGenHandler.addSurfaceGenerator(new WorldGenMinable(new ItemStack(ModBlocks.ores.blockID, 1, EnumOres.oreOpal.ordinal()), Properties.opalSize),
    ...
    private static void registerRuby()
    {
        ...
        WorldGenHandler.addSurfaceGenerator(new WorldGenMinable(new ItemStack(ModBlocks.ores.blockID, 1, EnumOres.oreRuby.ordinal()), Properties.rubySize),
    ...
    private static void registerSapphire()
    {
        ...
        WorldGenHandler.addSurfaceGenerator(new WorldGenMinable(new ItemStack(ModBlocks.ores.blockID, 1, EnumOres.oreSapphire.ordinal()), Properties.sapSize),
    ...
    private static void registerSQuartz()
    {
        ...
        WorldGenHandler.addNetherGenerator(new WorldGenMinable(new ItemStack(ModBlocks.ores.blockID, 1, EnumOres.oreSQuartz.ordinal()), Properties.squSize),
                                           Properties.squMinHeight,
                                           Properties.squMaxHeight,
                                           Properties.squDensity,
                                           WorldGenHandler.GenType.ORE_1.ordinal());
    }
    ...
    private static void registerSun()
    {
        ...
        WorldGenHandler.addSurfaceGenerator(new WorldGenMinable(new ItemStack(ModBlocks.ores.blockID, 1, EnumOres.oreSun.ordinal()), Properties.sunSize),
                                            Properties.sunMinHeight,
                                            Properties.sunMaxHeight,
                                            Properties.sunDensity,
                                            WorldGenHandler.GenType.ORE_1.ordinal());
    }
    ...
    private static void registerTopaz()
    {
        ...
        WorldGenHandler.addSurfaceGenerator(new WorldGenMinable(new ItemStack(ModBlocks.ores.blockID, 1, EnumOres.oreTopaz.ordinal()), Properties.topSize),
                                            Properties.topMinHeight,
                                            Properties.topMaxHeight,
                                            Properties.topDensity,
                                            WorldGenHandler.GenType.ORE_1.ordinal());
    }
    ...
    private static void registerTurquoise()
    {
        ...
        WorldGenHandler.addSurfaceGenerator(new WorldGenMinable(new ItemStack(ModBlocks.ores.blockID, 1, EnumOres.oreTurquoise.ordinal()), Properties.turSize),
                                            Properties.turMinHeight,
                                            Properties.turMaxHeight,
                                            Properties.turDensity,
                                            WorldGenHandler.GenType.ORE_1.ordinal());
    }
    ...
    private static void registerWAlabaster()
    {
        ...
        WorldGenHandler.addEndGenerator(new WorldGenMinable(new ItemStack(ModBlocks.ores.blockID, 1, EnumOres.oreWAlabaster.ordinal()), Properties.walSize),
                                        Properties.walMinHeight,
