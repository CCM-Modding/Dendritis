...
final class WorldRegistry
{
    ...
    private static void registerAmethyst()
    {
        ...
        WorldGenerator.addEndGen(Archive.MOD_NAME,
                                 new ItemStack(ModBlocks.ores.blockID, 1, EnumOres.oreAmethyst.ordinal()),
                                 EnumOres.oreAmethyst.name(),
                                 Properties.ameSize,
    ...
    private static void registerBDiamond()
    {
        ...
        WorldGenerator.addNetherGen(Archive.MOD_NAME,
                                    new ItemStack(ModBlocks.ores.blockID, 1, EnumOres.oreBDiamond.ordinal()),
                                    EnumOres.oreBDiamond.name(),
                                    Properties.bdiSize,
    ...
    private static void registerCitrine()
    {
        ...
        WorldGenerator.addOverworldGen(Archive.MOD_NAME,
                                       new ItemStack(ModBlocks.ores.blockID, 1, EnumOres.oreCitrine.ordinal()),
                                       EnumOres.oreCitrine.name(),
                                       Properties.citSize,
    ...
    private static void registerCZirconia()
    {
        ...
        WorldGenerator.addNetherGen(Archive.MOD_NAME,
                                    new ItemStack(ModBlocks.ores.blockID, 1, EnumOres.oreCZirconia.ordinal()),
                                    EnumOres.oreCZirconia.name(),
                                    Properties.cziSize,
    ...
    private static void registerFuchsia()
    {
        ...
        WorldGenerator.addOverworldGen(Archive.MOD_NAME,
                                       new ItemStack(ModBlocks.ores.blockID, 1, EnumOres.oreFuchsia.ordinal()),
                                       EnumOres.oreFuchsia.name(),
                                       Properties.fucSize,
    ...
    private static void registerJet()
    {
        ...
        WorldGenerator.addEndGen(Archive.MOD_NAME,
                                 new ItemStack(ModBlocks.ores.blockID, 1, EnumOres.oreJet.ordinal()),
                                 EnumOres.oreJet.name(),
                                 Properties.jetSize,
    ...
    private static void registerOlivine()
    {
        ...
        WorldGenerator.addOverworldGen(Archive.MOD_NAME,
                                       new ItemStack(ModBlocks.ores.blockID, 1, EnumOres.oreOlivine.ordinal()),
                                       EnumOres.oreOlivine.name(),
                                       Properties.oliSize,
    ...
    private static void registerOpal()
    {
        ...
        WorldGenerator.addOverworldGen(Archive.MOD_NAME,
                                       new ItemStack(ModBlocks.ores.blockID, 1, EnumOres.oreOpal.ordinal()),
                                       EnumOres.oreOpal.name(),
                                       Properties.opalSize,
    ...
    private static void registerRuby()
    {
        ...
        WorldGenerator.addOverworldGen(Archive.MOD_NAME,
                                       new ItemStack(ModBlocks.ores.blockID, 1, EnumOres.oreRuby.ordinal()),
                                       EnumOres.oreRuby.name(),
                                       Properties.rubySize,
    ...
    private static void registerSapphire()
    {
        ...
        WorldGenerator.addOverworldGen(Archive.MOD_NAME,
                                       new ItemStack(ModBlocks.ores.blockID, 1, EnumOres.oreSapphire.ordinal()),
                                       EnumOres.oreSapphire.name(),
                                       Properties.sapSize,
    ...
    private static void registerSQuartz()
    {
        ...
        WorldGenerator.addNetherGen(Archive.MOD_NAME,
                                    new ItemStack(ModBlocks.ores.blockID, 1, EnumOres.oreSQuartz.ordinal()),
                                    EnumOres.oreSQuartz.name(),
                                    Properties.squSize,
    ...
    private static void registerSun()
    {
        ...
        WorldGenerator.addOverworldGen(Archive.MOD_NAME,
                                       new ItemStack(ModBlocks.ores.blockID, 1, EnumOres.oreSun.ordinal()),
                                       EnumOres.oreSun.name(),
                                       Properties.sunSize,
    ...
    private static void registerTopaz()
    {
        ...
        WorldGenerator.addOverworldGen(Archive.MOD_NAME,
                                       new ItemStack(ModBlocks.ores.blockID, 1, EnumOres.oreTopaz.ordinal()),
                                       EnumOres.oreTopaz.name(),
                                       Properties.topSize,
    ...
    private static void registerTurquoise()
    {
        ...
        WorldGenerator.addOverworldGen(Archive.MOD_NAME,
                                       new ItemStack(ModBlocks.ores.blockID, 1, EnumOres.oreTurquoise.ordinal()),
                                       EnumOres.oreTurquoise.name(),
                                       Properties.turSize,
    ...
    private static void registerWAlabaster()
    {
        ...
        WorldGenerator.addEndGen(Archive.MOD_NAME,
                                 new ItemStack(ModBlocks.ores.blockID, 1, EnumOres.oreWAlabaster.ordinal()),
                                 EnumOres.oreWAlabaster.name(),
                                 Properties.walSize,
                                 Properties.walDensity,
                                 Properties.walMinHeight,
                                 Properties.walMaxHeight,
                                 Properties.enableWorldGenWAlabaster);
    }
